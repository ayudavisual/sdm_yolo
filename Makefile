...
#Arquitectura HP Pacho GTX 1050 
#ARCH= --gpu-architecture=compute_61 --gpu-code=[sm_61]

#arquitectura maquina virtual azure K80
#ARCH= --gpu-architecture=compute_30 --gpu-code=[sm_30,compute_30]
